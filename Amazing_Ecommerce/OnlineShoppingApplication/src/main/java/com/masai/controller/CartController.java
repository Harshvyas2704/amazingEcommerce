...
public class CartController {
	...
	public ResponseEntity<Cart>addorder(@RequestBody Cart cart,@PathVariable Integer id,@PathVariable Integer custId) throws CustomerException, ProductException{
	...
	public ResponseEntity<String> removeCartProduct(@PathVariable("id") Integer id) throws ProductException{
